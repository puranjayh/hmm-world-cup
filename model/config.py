...
STATE_LABELS   = ["Very Poor", "Poor", "Below Neutral", "Neutral", "Above Neutral", "Peak", "Dominant"]   # state index 0,1,2,3,4
...
RANDOM_SEED    = 42
MIN_MATCHES    = 62    # minimum training matches per team to fit an HMM
